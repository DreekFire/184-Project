...
private:
  ...
  Vector3D m_gl_skybox_posx_size;
  Vector3D m_gl_skybox_negx_size;
  Vector3D m_gl_skybox_posy_size;
  Vector3D m_gl_skybox_negy_size;
  Vector3D m_gl_skybox_posz_size;
  Vector3D m_gl_skybox_negz_size;
  ...
  GLuint m_gl_ripples;
  GLuint m_gl_skybox_posx;
  GLuint m_gl_skybox_negx;
  GLuint m_gl_skybox_posy;
  GLuint m_gl_skybox_negy;
